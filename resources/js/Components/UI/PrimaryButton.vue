<template>
    <button
        class="inline-flex items-center px-4 py-2 bg-blue-800 shadow shadow-gray-500 border
            border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest
            hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2
