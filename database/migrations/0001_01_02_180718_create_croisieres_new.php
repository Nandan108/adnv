...
return new class extends Migration
{
    ...
    {
        Schema::create('croisieres_new', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('dates_depart')->nullable();
            $table->unsignedTinyInteger('nb_nuit')->default(1);
            $table->enum('type_repas', ['Sans repas', 'Petit déjeuner', 'Demi-pension', 'Pension complète', 'All Inclusive', 'Selon programme'])->default('Selon programme');
            $table->enum('type_depart', ['quotidien', 'programmé']);
            $table->enum('type_croisiere', ['maritime', 'fluviale']);
...
_2_net', 8, 2)->nullable();
    ...
    {
        Schema::dropIfExists('croisieres_new');
    }
};