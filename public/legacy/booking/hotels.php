        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    ...
                    <p class="tm-color-white tm-section-subtitle" style='padding-bottom: 1rem;line-height:120%'>
                    ...
                    <div class="row container_list_hotel">
                        ...
                        <div class="col-sm-4">
                            <form class="display_none" action="" style="background: #01ccf4;padding: 20px;">
                                <div class="col-sm-12">
                                    <h3 style="color: #fff;font-weight: 100;"><span style="font-weight: 1000;color: #000">Filtrer </span>votre recherche
                                    </h3>
                                    <hr>
                                </div>
                                    ...
                                    <div class="row filter_block">
                                        ...
                                        <div class="atgrid__item__rating">
                                            ...
                                            foreach (range(4, 7) as $i) {
                                                ?>
                                                <input type='radio' name='classement' value='<?= $i ?>' id='<?= $id = "classement-$i" ?>' />
                                                &nbsp;&nbsp; <label for='<?= $id ?>'>
                                                    <?= $i ?> étoiles
                                                </label><br />
                                                <?php
                                            ...
                                            ?>
                                            <input type="radio" name="classement" value="0" checked="checked" id='classement-0'>
                                            &nbsp;&nbsp; <label for='classement-0' style="color: black;">Afficher tous les hôtels</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                                    ...
                                                    foreach ($hotels as $hotel) {
                                                        ...
                                                        <tr data-rating='<?= $hotel->etoiles ?>'>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="col-sm-12 liste_hotel" style="box-shadow: 0 0px 4px -1px #CCC;padding: 0;">
                                                                    <div class="row listing_block">
                                                                        <div class="col-sm-4">
                                                                            <a class="atlist__item__image-wrap"
                                                                                href="hotel_detail.php?h=<?= $hotel->id ?>&<?= $search_query ?>"
                                                                                target="_parent">
                                                                                <img class="img-reponsive" src="<?= $base_url_photo . $hotel->photo; ?>"
                                                                                    alt="<?= $hotel->nom; ?>" style="width: 100%;height: 190px;">
                                                                                <?php
                                                                                // Si remise existe
                                                                                echo $remisePct ?
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-7" style="padding: 10px 45px;">
                                                                                    <div class="row">
                                                                                        <p
                                                                                        ...
                                                                                        <div class="clearfix listing_desc"
                                                                                            ...
                                                                                            <p style="font-weight: 100;color: #000;line-height: 0px;">
                                                                                                <?= $compteNomChambre; ?>
                                                                                        ...
                                                                                        <div class="col-sm-12">
                                                                                            <div class="row listing_bottom" style="font-weight: 1000;">
                                                                                                ...
                                                                                                <p
                                                                                                    ...
                                                                                                    <br>* Prix par nuit et par adulte
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-sm-5 display_none" style="padding: 23px 10px;">
                                                                                    <div class="row listing_right" style="text-align: center;">
                                                                                        <p style="line-height: 0px;width: 100%;font-size: 12px;">
                                                                                            à partir de
                                                                                        </p>
                                                                                        <p
                                                                                            style="line-height: 0px;width: 100%;font-size: 26px;font-weight: 1000;color: #000;margin: 20px 0 2px 0;">
                                                                                            <?= $chf($prix_chambre) ?>
                                                                                            <span style="font-size: 16px;">CHF</span><br><br>
                                                                                        </p>

                                                                                        <p
                                                                                            style="line-height: 0px;width: 100%;font-size: 26px;font-weight: 1000;color: #000;margin: 16px 0;">
                                                                                            <?php
                                                                                            echo $remisePct ? "<del style='color: #f00;font-size: 0.6em;'>" . number_format($prix_chambre_plein, 2, ',', "'") . " CHF</del>" : '';
                                                                                            ?>
                                                                                        </p>
                                                                                ...
                                                                                <div class="col-sm-5 display_none_1" style="padding: 0px 10px 23px 10px;">
                                                                                    <div class="col-sm-5" style="text-align: center;">
                                                                                        ...
                                                                                        <p
                                                                                            style="line-height: 0px;width: 100%;font-size: 26px;font-weight: 1000;color: #000;margin: 16px 0;">
                                                                                            <?php
                                                                                            echo $prix_chambre != $hotel->prix_adulte ? "<del style='color: #f00;font-size: 0.6em;'>" . number_format($hotel->prix_adulte, 2, ',', "'") . " CHF</del>" : '';
                                                                                            ?>
                                                                                        </p>

                                                                                        <p style="line-height: 0px;width: 100%;margin-bottom: 0;">
                                                                                            <a href="hotel_detail.php?h=<?= $hotel->id; ?>&<?= $search_query ?>&mobile=<?= $mobile ?>"
                                                                                                class="btn btn-primary btn-red pull-right"
