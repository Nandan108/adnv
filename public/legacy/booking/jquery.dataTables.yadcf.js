...
* omit_default_label
                ...
                Type:               boolean
                Default value:      false
                Description:        Prevent yadcf from adding "default_label" (Afficher tous / Afficher tous)
...
(function (root, factory) {
	...
	var yadcf = (function () {
		...
		var tablesDT = {},
			...
			placeholderLang = {
				'select': 'Afficher tous',
				'select_multi': 'Afficher tous',
			...
			for (columnsArrIndex = 0; columnsArrIndex < filtersOptions.length; columnsArrIndex++) {
				...
				if (columnsObj.filter_default_label === undefined) {
					if (columnsObj.filter_type === "select" || columnsObj.filter_type === 'custom_func') {
						columnsObj.filter_default_label = "Afficher tous";
