<div class="col-sm-12" id="option_autre_vol_<?php echo $account5 -> idtxp; ?>" style="display : none">
...
function myFunctionAdulteOption_<?php echo $account8 -> id_option; ?>() {
  ...
  if (checkBox.checked == true)
  {
    ...
    document.getElementById("id_option_adulte<?php echo $account5 -> idtxp; ?>").value = document.getElementById("id_option_adulte<?php echo $account5 -> idtxp; ?>").value + '-' + <?php echo $account8 -> id_option; ?>;
    ...
    document.getElementById("prix_vol_id").innerHTML = newprix + "<span style='font-size: 12px;'> CHF</span>";
    document.getElementById("prix_vol_input_<?php echo $account5 -> idtxp; ?>").value = newprix1;
    var str = document.getElementById("id_option_adulte<?php echo $account5 -> idtxp; ?>").value;
    document.getElementById("id_option_adulte<?php echo $account5 -> idtxp; ?>").value = str.replace(<?php echo $account8 -> id_option; ?>, "");
...
function myFunctionEnfantOption_<?php echo $account8 -> id_option; ?>() {
  ...
  if (checkBoxEnfant.checked == true)
  {
    ...
    document.getElementById("prix_vol_id").innerHTML = newprix + "<span style='font-size: 12px;'> CHF</span>";
    document.getElementById("prix_vol_input_<?php echo $account5 -> idtxp; ?>").value = newprix1;
    document.getElementById("id_option_enfant<?php echo $account5 -> idtxp; ?>").value = document.getElementById("id_option_enfant<?php echo $account5 -> idtxp; ?>").value + '-' + <?php echo $account8 -> id_option; ?>;
    ...
    document.getElementById("prix_vol_id").innerHTML = newprix + "<span style='font-size: 12px;'> CHF</span>";
    document.getElementById("prix_vol_input_<?php echo $account5 -> idtxp; ?>").value = newprix1;
    var str = document.getElementById("id_option_enfant<?php echo $account5 -> idtxp; ?>").value;
    document.getElementById("id_option_enfant<?php echo $account5 -> idtxp; ?>").value = str.replace(<?php echo $account8 -> id_option; ?>, "");
  }
}
</script>
...
function myFunctionbebeOption_<?php echo $account8 -> id_option; ?>() {
  ...
  if (checkBoxbebe.checked == true)
  {
    ...
    document.getElementById("prix_vol_id").innerHTML = newprix + "<span style='font-size: 12px;'> CHF</span>";
    document.getElementById("prix_vol_input_<?php echo $account5 -> idtxp; ?>").value = newprix1;
    document.getElementById("id_option_bebe<?php echo $account5 -> idtxp; ?>").value = document.getElementById("id_option_bebe<?php echo $account5 -> idtxp; ?>").value + '-' + <?php echo $account8 -> id_option; ?>;
    ...
    document.getElementById("prix_vol_id").innerHTML = newprix + "<span style='font-size: 12px;'> CHF</span>";
    document.getElementById("prix_vol_input_<?php echo $account5 -> idtxp; ?>").value = newprix1;
    var str = document.getElementById("id_option_bebe<?php echo $account5 -> idtxp; ?>").value;
    document.getElementById("id_option_bebe<?php echo $account5 -> idtxp; ?>").value = str.replace(<?php echo $account8 -> id_option; ?>, "");
  }
}
</script>
...
<div class="col-sm-12" id="option_repas_vol<?php echo $account5 -> idtxp; ?>" style="display : none">
