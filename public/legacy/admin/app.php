...
<form id="userSecurityForm" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="btn-group-box">
                            ...
                            <button class="btn"><a href="clients.php" style="text-decoration: none;color : #555555"><i class="icon-user icon-large" style="font-size: 100px"></i><br/><br/>Gestion de client
                                </a>
<?php 
$i=0;
...
if($i!=0)
{
    ?>
        ...
        <br><br><span style="font-size: 12px;background: #2AC99C;padding: 5px 10px;color: #FFF;text-shadow: 0 0 0;"><?php echo $i;  ?> Client(s)</span>
    <?php
}
?>
                            ...
                            <button class="btn"><a href="cartes.php" style="text-decoration: none;color : #555555"><i class="icon-map-marker icon-large" style="font-size: 100px"></i><br/><br/>Cartes</a>
...
if($i!=0)
{
    ?>
        ...
        <br><br><span style="font-size: 12px;background: #F4A06D;padding: 5px 10px;color: #FFF;text-shadow: 0 0 0;"><?php echo $i;  ?> Cartes</span>
    <?php
}
?>
...
<button class="btn"><a href="cartes_client.php" style="text-decoration: none;color : #555555"><i class="icon-map-marker icon-large" style="font-size: 100px"></i><br/><br/>Cartes Client</a>
