...
<div id="acct-password-row" class="span4">
                            <fieldset>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <select class="span4" id="name" name="recommande" style="margin-left: -84px;">
                                            ...
                                            <option value="Pas recommandé">Pas recommandé</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="code_postale" class="span4" type="text" value="" autocomplete="false" >
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="site" class="span4" type="text" value="" autocomplete="false" >
