<?php
  ...
  include_once ("../database.php");
    ...
    $id_vol_devis_client_circuit = $_POST['id'];
    $id_reservation_info_devis_client_circuit = $_POST['id_devis'];

    


 $stmt5 = $conn ->prepare ('UPDATE vol_devis_client_circuit SET date =:date, 
   num =:num, depart =:depart, arrive =:arrive, heure_depart =:heure_depart, heure_arrive =:heure_arrive  WHERE id_vol_devis_client_circuit =:id_vol_devis_client_circuit');
   ...
   $stmt5->bindValue('id_vol_devis_client_circuit', $id_vol_devis_client_circuit);
