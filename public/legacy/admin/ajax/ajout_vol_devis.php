<?php
  ...
  include_once ("../database.php");
    ...
    $id_reservation_info_devis_client = $_POST['id_reservation_info_devis_client'];
    $date = $_POST['date'];
    $num = $_POST['num'];
    $depart = $_POST['depart'];
    $arrive = $_POST['arrive'];
    ...
    $stmt55 = $conn ->prepare ("insert into `vol_devis_client` (`date`, `num`, `depart`, `arrive`, `heure_depart`, `heure_arrive`, `id_reservation_info_devis_client`) VALUE (:date, :num, :depart, :arrive, :heure_depart, :heure_arrive, :id_reservation_info_devis_client)");
   ...
   $stmt55->bindValue('id_reservation_info_devis_client', $id_reservation_info_devis_client);
   $stmt55->execute();
