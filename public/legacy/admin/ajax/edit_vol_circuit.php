<?php
 ...
 $stmt5 = $conn ->prepare ('UPDATE vol_circuit SET date =:date,
   num =:num, depart =:depart, arrive =:arrive, heure_depart =:heure_depart, heure_arrive =:heure_arrive  WHERE id_vol_circuit =:id_vol_circuit');
   ...
   $stmt5->bindValue('id_vol_circuit', $id_vol_circuit);
