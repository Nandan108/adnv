...
?></td>
                                          ...
                                          <td><a href="ajout_devis_circuit_etape3.php?id=<?php echo MD5($id_reservation_info_circuit); ?>&idxx=<?php echo $accountx -> id_vol_circuit; ?>&action=delete" onclick="return confirm('Vous etes sur de supprimer cette enregistrement?')" class="btn btn-danger" id="delete_vol">Supprimer</a>
