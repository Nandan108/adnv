...
$ville = $_GET['ville'];
        ...
        echo "<meta http-equiv='refresh' content='0;url=package_manuel-ville.php?pays=$pays&ville=$ville'/>";
}
        ...
        ?>
                    ...
                    <div id="Person-<?php echo $i; ?>" class="box">
                        <div class="box-header">
                            ...
                            <h5><?php echo ($account -> pays); ?>&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="ajout_package_manuel.php?pays=<?php echo ($account -> pays); ?>" class="btn btn-danger" style="margin: -11px 0 0 0;
font-size: 12px;
padding: 5px 11px;
...
?>
                        ...
                        ?>                 
                                ...
                                <tr>
                                    <td>
                                         <?php
                                                    ...
                                                    {
                                                        ?>
                                                        <a href="package_manuel-ville.php?id_sejour=<?php echo $account -> id_sejour; ?>&action=avant&pays=<?php echo $pays; ?>&ville=<?php echo $ville; ?>" onclick="return confirm('Voulez-vous mettre cette offre en avant')" class="btn" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Mettre en avant</a>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                                                                                ?>
                                                        <a href="package_manuel-ville.php?id_sejour=<?php echo $account -> id_sejour; ?>&action=normal&pays=<?php echo $pays; ?>&ville=<?php echo $ville; ?>" onclick="return confirm('Voulez-vous mettre cette offre en avant')" class="btn btn-primary" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Desactiver mise en avant</a>
                                                        <?php
                                                    }
                                ...
                                Hôtel   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; : <?php echo (stripslashes($account19 -> hotel)); ?>
                                <hr>
...
<div id="acct-verify-row" class="span4">
    ...
    <small class="text-muted"> <b>Adulte 3 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte3_sejour_3; ?>&nbsp;</small><br>
                                    ...
                                    <td>
                                        ...
                                        <a href="package_manuel-ville.php?id_sejour=<?php echo $account -> id_sejour; ?>&action=delete&pays=<?php echo $pays; ?>&ville=<?php echo $ville; ?>" onclick="return confirm('Vous etes sur de supprimer cette ligne? Cette action va supprimer tous les informations réliées à cette enregistrement')" class="btn" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Supprimer</a>
                                        <br>
                                        <a href="modification_package_manuel.php?id_sejour=<?php echo $account -> id_sejour; ?>" class="btn" style="font-size: 10px;padding: 0 14px;margin-bottom: 5px;"><i class="icon-edit"></i> Modifier</a>
                                        <br>
                                        <a href="duplication_package_manuel.php?id_sejour=<?php echo $account -> id_sejour; ?>" class="btn" style="font-size: 10px;padding: 0 12px;margin-bottom: 5px;"><i class="icon-bookmark"></i> Dupliquer</a>
