<?php
require_once dirname(dirname(__DIR__)) . '/adnv/bootstrap.php';
?>
...
<body style="background: none">
    <div class="col-sm-12">
        ...
        */
        $stmt1 = $conn->prepare("SELECT * FROM circuit WHERE id_circuit !=:id_circuit ORDER BY rand() ASC LIMIT 0, 4");
        $stmt1->bindValue('id_circuit', '1');
        $stmt1->execute();
        while ($account1 = $stmt1->fetch(PDO::FETCH_OBJ)) {
            ...
            <div class="col-sm-3">
                ...
                <a href="<?php echo $urlsite; ?>detail-circuit/<?php echo $account1->id_circuit; ?>/"
                    ...
                    if ($account1->photo == '' or $account1->photo == '<?php echo $urlbase; ?>/no_image_available.png') {
                        ?>
                        <img class="img_circuit" src="<?php echo $urlbase; ?>/no_image_available.png" width="500" height="250"
                            style="height: 250px !important">
                        <?php
                    } else {
                        ?>
                        <img class="img_circuit" src="<?php echo $urlphoto . $account1->photo; ?>" width="500" height="250"
                            style="height: 250px !important">
                        <?php
                    }
                    ...
                    <div class="col-sm-12" style="background: #FFF;font-size: 11px;color: #333;padding: 0;">
                        ...
                        <div class="col-sm-12" style="line-height: 16px;margin-top: 20px;">
                            <span class="titre_ville" style="line-height: 14px;font-size: 11px;">
                                <ul>
                                    <li>Circuit
                                        <?php echo ($account1->type_circuit); ?>
                                    </li>
                                    <li>Cabine
                                    ...
                                    <li>
                                        <?php if ($account1->id_vol == 0) {
                                            echo "Sans vol inclus";
                                        } else {
                                            echo "Vol inclus";
                                        } ?>
                                    </li>
