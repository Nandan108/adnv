                    ...
                    <div class="btn-group-box">
                        ...
                        <button class="btn">
                            <a href="<?= route('admin.reservation.index') ?>"
                                ...
                                <i class="icon-tasks icon-large" style="font-size: 100px"></i><br />
                                <br />
                                Réservations Hôtel
                            </a>
                            <?php
                            ...
                            if ($i != 0) {
                                ...
                                <br><br><span
                                    style="font-size: 12px;background: #2AC99C;padding: 5px 10px;color: #FFF;text-shadow: 0 0 0;">+
                                    <?php echo $i; ?> Nouveau dévis</span>
                                <?php
                            }
                            ?>
                        </button>

                        <button class="btn"><a href="devis_sejour.php" style="text-decoration: none;color : #555555"><i
                                    class="icon-calendar icon-large"
                                    style="font-size: 100px"></i><br /><br />Réservations Séjour</a>
                            ...
                            if ($i != 0) {
                                ...
                                <br><br><span
                                    style="font-size: 12px;background: #0BA6E2;padding: 5px 10px;color: #FFF;text-shadow: 0 0 0;">+
                                    <?php echo $i; ?> Nouveau dévis</span>
                                <?php
                            }
                            ?>
                        ...
                        <button class="btn"><a href="devis_circuit.php" style="text-decoration: none;color : #555555"><i
                                    class="icon-map-marker icon-large"
                                    style="font-size: 100px"></i><br /><br />Réservations Circuit</a>
                            <?php
                            $i    = 0;
                            ...
                            if ($i != 0) {
                                ...
                                <br><br><span
                                    style="font-size: 12px;background: #F4A06D;padding: 5px 10px;color: #FFF;text-shadow: 0 0 0;">+
                                    <?php echo $i; ?> Nouveau dévis</span>
                                <?php
                            }
                            ?>
                        ...
                        <button class="btn"><a href="devis_client.php" style="text-decoration: none;color : #555555"><i
                                    class="icon-copy icon-large" style="font-size: 100px"></i><br /><br />Devis
                                client</a>
                        ...
                        <button class="btn"><a href="devis_client_circuit.php"
                                style="text-decoration: none;color : #555555"><i class="icon-copy icon-large"
                                    style="font-size: 100px"></i><br /><br />Devis client circuit</a>
                            <?php
                            $i    = 0;
