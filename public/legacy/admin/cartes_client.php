                    ...
                    <div class="span9">
                        <ul class="nav nav-pills">
                            ...
                            <li>
                                ...
                                <a href="carte_client_voir.php" rel="tooltip" data-placement="left"
                                    title="Nouvelle carte_client">
                            ...
                            <li>
                                ...
                                <a href="ajout_carte_client.php" rel="tooltip" data-placement="left"
                                    title="Nouvelle carte client">
                ...
                <div class="span4">
                    <div class="blockoff-right">
                        <ul id="person-list" class="nav nav-list">
                            ...
                            <?php
                            $i = 1;
                            $stmt = $conn->prepare('SELECT * FROM carte_client  GROUP BY pays');
                            $stmt->execute();
                            while ($account = $stmt->fetch(PDO::FETCH_OBJ)) {
                                ...
                                <li>
                                    ...
                                    <ul id="liste-<?php echo ($pays1) . '_' . $i; ?>" style="display: none">
                                        <?php
                                        $s = 0;
                                        $stmt70 = $conn->prepare('SELECT * FROM carte_client WHERE pays =:pays GROUP BY ville');
                                        ...
                                        while ($account70 = $stmt70->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <li>
                                                <a
                                                    href="carte_client-ville.php?pays=<?php echo ($account->pays); ?>&ville=<?php echo ($account70->ville); ?>">
                            ...
                            <div class="box-content box-table">
                                <table class="table table-hover tablesorter">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $v = 1;
                                        $stmt1 = $conn->prepare('SELECT * FROM carte_client WHERE pays =:pays ORDER BY quartier, categorie, titre');
                                        ...
                                        while ($account1 = $stmt1->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="cartes_client.php?id_carte_client=<?php echo $account1->id_carte_client; ?>&action=delete"
                                                        onclick="return confirm('Vous etes sur de supprimer cette ligne')" class="btn"
                                                        style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i
                                                            class="icon-trash"></i> Supprimer</a>
                                                    <br>
                                                    <a href="modif_carte_client.php?id_carte_client=<?php echo $account1->id_carte_client; ?>"
                                                        class="btn" style="font-size: 10px;padding: 0 14px;margin-bottom: 5px;"><i
                                                            class="icon-edit"></i> Modifier</a><br>

                                                    <a href="dupliquer_carte_client.php?id_carte_client=<?php echo $account1->id_carte_client; ?>"
