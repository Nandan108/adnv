<?php
 ...
 $xx=$_GET['id'];
  ...
  while($account = $stmt ->fetch(PDO::FETCH_OBJ))
  {
    ...
    $stmt5 = $conn ->prepare ('UPDATE reservation_info_devis_client SET hotel =:hotel, 
   repas =:repas, chambre =:chambre,
   titre_transfert =:titre_transfert, 
   ...
   $stmt5->bindValue('hotel','');
   $stmt5->bindValue('repas','');
   $stmt5->bindValue('chambre',''); 
   $stmt5->bindValue('titre_transfert',''); 
   $stmt5->bindValue('depart_transfert',''); 
   $stmt5->bindValue('arrive_transfert','');
   $stmt5->bindValue('check_in','');
   $stmt5->bindValue('check_out',''); 
   $stmt5->execute();
...
/*
   ...
   */
   ...
   $stmt5->bindValue('id_reservation_info_devis_client',addslashes($_POST['id_reservation_info_devis_client']));  
   $stmt5->bindValue('hotel',addslashes(($_POST['hotel'])));
   $stmt5->bindValue('repas',addslashes(($_POST['repas'])));
   $stmt5->bindValue('chambre',addslashes(($_POST['chambre']))); 
   $stmt5->bindValue('titre_transfert',addslashes($_POST['titre_transfert'])); 
   ...
   $stmt5->bindValue('check_in',addslashes(($_POST['check_in'])));
   $stmt5->bindValue('check_out',addslashes(($_POST['check_out']))); 
   $stmt5->execute();

?>
            <script type="text/javascript">
           window.location.href = 'ajout_devis_client_etape3.php?id=<?php echo $id; ?>';
            </script>
<?php
            ...
            <form id="userSecurityForm" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                <div class="container">
                    ...
                    <div class="alert alert-block alert-info">
                        <h2>ETAPE 2 : HOTEL & TRANSFERT</h2>
                    </div>
                    <div class="row">



                        <div id="acct-password-row" class="span8" style="height: 350px;">
                            ...
                            <fieldset>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="hotel" class="span5" type="text" value="" autocomplete="false" style="margin-left: -40px;">
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="chambre" class="span5" type="text" value="" autocomplete="false" style="margin-left: -40px;">
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <select id="challenge_question_control" class="span5" name="repas" style="margin-left: -40px;">
                                                <option value="Petit déjeuner">Petit déjeuner</option>
                                                <option value="Demi-pension">Demi-pension</option>
                                                <option value="Pesion complète">Pesion complète</option>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="check_in" class="span5" type="date" value="" autocomplete="false"  style="margin-left: -40px;">
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="check_out" class="span5" type="date" value="" autocomplete="false"  style="margin-left: -40px;">
                        ...
                        <div id="acct-verify-row" class="span8" style="height: 350px;">
...
✘ Assurance de voyages obligatoire (nous consulter) 
                    ...
                    <footer id="submit-actions" class="form-actions">
                        ...
                        <button id="submit-button" type="submit" class="btn btn-primary" name="save" value="CONFIRM">Passer à l'étape suivant</button>
                        <!--
                        <button id="submit-button" type="submit" class="btn btn-success" name="save2" value="CONFIRM">Passer à l'étape suivant</button>-->
