...
if (isset($_SESSION['account_login'])) {
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'delete') {
        ...
        echo "<meta http-equiv='refresh' content='0;url=package_manuel_vol.php'/>";
    }
                    ...
                    <ul id="person-list" class="nav nav-list">
                        ...
                        while ($account = $stmt->fetch(PDO::FETCH_OBJ)) {
                            ...
                            <li>
                                ...
                                <a href="#Person-<?php echo $i; ?>" id="<?php echo ($pays1) . '_' . $i; ?>_1"
                                    style="display: none">
                                    <i class="icon-chevron-right pull-right"></i>
                                    <?php echo ($account->pays); ?>
                                </a>
                                ...
                                <ul id="liste-<?php echo ($pays1) . '_' . $i; ?>" style="display: none">
                                    ...
                                    $stmt70->bindValue('manuel', '2');
                                    $stmt70->execute();
                                    while ($account70 = $stmt70->fetch(PDO::FETCH_OBJ)) {
                                        ?>
                                        <li>
                                            <a
                                                href="package_manuel_vol-ville.php?pays=<?php echo ($account->pays); ?>&ville=<?php echo ($account70->ville); ?>">
                        ...
                        <div class="box-header">
                            ...
                            <h5>
                                <?php echo ($account->pays); ?>&nbsp;&nbsp;&nbsp;&nbsp;<span><a
                                        href="ajout_package_manuel_vol.php?pays=<?php echo ($account->pays); ?>"
                                        ...
                                        while ($account = $stmt1->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    if ($account->avant == "0") {
                                                        ?>
                                                        <a href="package_manuel_vol.php?id_sejour=<?php echo $account->id_sejour; ?>&action=avant"
                                                        ...
                                                        ?>
                                                        <a href="package_manuel_vol.php?id_sejour=<?php echo $account->id_sejour; ?>&action=normal"
                                                ...
                                                <td>
                                                    ...
                                                    Compagnie &nbsp;&nbsp; &nbsp;&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                                                    <?php echo (stripslashes($account19->compagnie)); ?><br>
                                                    Class de réservation &nbsp;&nbsp;:
                                                    <?php echo (stripslashes($account19->class_reservation)); ?><br>
                                                    Ville de départ
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                                    <?php echo (stripslashes($account19->ville_depart)); ?><br>
                                                    Ville d' arrivée
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                                                    <?php echo (stripslashes($account19->ville_arrive)); ?>
                                                    <hr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="package_manuel_vol.php?id_sejour=<?php echo $account->id_sejour; ?>&action=delete"
                                                    ...
                                                    <br>
                                                    <a href="modification_package_manuel_vol.php?id_sejour=<?php echo $account->id_sejour; ?>"
                                                        class="btn" style="font-size: 10px;padding: 0 14px;margin-bottom: 5px;"><i
                                                            class="icon-edit"></i> Modifier</a>
                                                    <br>
                                                    <a href="duplication_package_manuel_vol.php?id_sejour=<?php echo $account->id_sejour; ?>"
