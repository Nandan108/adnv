<form id="userSecurityForm" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'deletevisa') {

        $stmt = $conn->prepare('delete from client_visa WHERE id_client_visa = :id_client_visa');
        $stmt->bindValue('id_client_visa', $_GET['id_client_visa']);
        $stmt->execute();
    ...
    <div style="padding: 30px;">
        ...
        <table style="width: 100%;">
            ...
            $stmt700 = $conn->prepare('SELECT * FROM client_visa WHERE id_client =:id_client');
            ...
            while ($account700 = $stmt700->fetch(PDO::FETCH_OBJ)) {
                ...
                <tr>
                    ...
                    <td><a href="https://adnvoyage.com/admin/document/<?php echo $account700->visa; ?>" target="_blank"><img
                                src="https://adnvoyage.com/admin/document/pdf.png" width="15" height="20">
                            <?php echo $account700->visa; ?>
                        </a></td>
                    <td style="text-align: center"><a
                            href="gerer_client.php?menus=<?= $url ?>&id_client_visa=<?php echo $account700->id_client_visa; ?>&action=deletevisa"
        ...
        <div class="control-group ">
            <label class="control-label">visa en PDF</label>
            <div class="controls">
        ...
        <footer id="submit-actions" class="form-actions">
            ...
            <button id="submit-button" type="submit" class="btn btn-primary" name="save_visa"
                value="CONFIRM">Enregistrer ce visa</button>
        ...
        if (isset($_POST['save_visa'])) {
            ...
            $stmt = $conn->prepare("insert into `client_visa`(`visa`, `date_ajout`, `id_client_passager`, `id_client`) VALUE (:visa,:date_ajout,:id_client_passager,:id_client)");
            $stmt->bindValue('visa', $url_photo);
            ...
            echo "<script type='text/javascript'>alert('Ajout de visa effectué, vous pouvez ajouter des autres visas');</script>";
