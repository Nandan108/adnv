...
if (isset($_SESSION['account_login'])) {
    ...
    <body>
        ...
        <div id="body-container">
            <div id="body-content">
                ...
                <link href="https://adnvoyage.com/admin/font-awesome/css/font-awesome.min.css" rel="stylesheet"
                    type="text/css">
                ...
                <section id="my-account-security-form" class="page container">
                    <form id="userSecurityForm" name="form2" class="form-horizontal" method="post" action=""
                        enctype="multipart/form-data">
                        <div class="container">

                            <input type="hidden" value="<?php echo $id_reservation_info_devis_client; ?>"
                                name="id_reservation_info_devis_client">
                                ...
                                <div id="acct-password-row" class="span8">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="control-group ">
                                            ...
                                            <div class="controls">
                                                <input id="current-pass-control" name="classe" class="span5" type="text"
                                                    value="" autocomplete="false" required>
                                        ...
                                        while ($accountx = $stmtx->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            if (isset($accountx->id_vol_devis_client)) {
                                                ...
                                                <tr id="show-edit<?php echo $accountx->id_vol_devis_client; ?>">
                                                    ...
                                                    <td><a href="ajout_devis_client_etape3.php?id=<?php echo MD5($id_reservation_info_devis_client); ?>&idxx=<?php echo $accountx->id_vol_devis_client; ?>&action=delete"
                                                            onclick="return confirm('Vous etes sur de supprimer cette enregistrement?')"
                                                            class="btn btn-danger" id="delete_vol">Supprimer</a>

                                                        <a href="javascript:void(0)" class="btn btn-primary"
                                                            id="edit<?php echo $accountx->id_vol_devis_client; ?>">Modifier</a>

                                                    </td>
                                                </tr>

                                                <tr id="hide-edit<?php echo $accountx->id_vol_devis_client; ?>"
                                                    style="display: none;">
                                                    <td><input type="date" name="date<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->date; ?>" style="width: 120px;"></td>
                                                    <td><input type="text" name="num<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->num; ?>" style="width: 120px;"></td>
                                                    <td><input type="text"
                                                            name="depart<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->depart; ?>" style="width: 120px;"></td>
                                                    <td><input type="text"
                                                            name="arrive<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->arrive; ?>" style="width: 120px;"></td>
                                                    <td><input type="text"
                                                            name="heure_depart<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->heure_depart; ?>" style="width: 120px;">
                                                    </td>
                                                    <td><input type="text"
                                                            name="heure_arrive<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->heure_arrive; ?>" style="width: 120px;">
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="id<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->id_vol_devis_client; ?>">

                                                        <input type="hidden"
                                                            name="id_devis<?php echo $accountx->id_vol_devis_client; ?>"
                                                            value="<?php echo $accountx->id_reservation_info_devis_client; ?>">


                                                        <a href="javascript:void(0)" class="btn btn-primary"
                                                            id="save<?php echo $accountx->id_vol_devis_client; ?>">Enregistrer</a>
                                                    </td>
                                                </tr>
        ...
        ✘ Vos dépenses personnelles</textarea>
                            ...
                            <footer id="submit-actions" class="form-actions">
                                ...
                                <button type="submit" class="btn btn-success" name="save"
                                    value="Enregistrer le vol et passer à l'Etape suivant">Enregistrer le vol et passer à
                                    l'Etape suivant</button>

                                <!--
                        <a href="ajout_devis_client_etape4?id=<?php echo MD5($id_reservation_info_devis_client); ?>" id="submit-button" class="btn btn-primary" name="save">Enregistrer le vol et passer à l'Etape suivante</a>
                        -->
                            </footer>
                        </div>
                    </form>
        ...
        <script type="text/javascript">
            ...
            $("#ajout_vol").click(function () {
                ...
                var id_reservation_info_devis_client = document.form2.id_reservation_info_devis_client.value;



                $.ajax({

                    url: "ajax/ajout_vol_devis.php",
                    method: "POST",
                    data: { id_reservation_info_devis_client: id_reservation_info_devis_client, date: date, num: num, depart: depart, arrive: arrive, heure_depart: heure_depart, heure_arrive: heure_arrive },
                    success: function (data) {
                        $('#vol_liste').html(data);
    ...
    if (isset($_POST['save'])) {
        ...
        $stmt5 = $conn->prepare(
            'UPDATE reservation_info_devis_client
            SET titre =:titre, classe =:classe
        ...
        <script type="text/javascript">
            window.onload = function () {
                location.href = "https://adnvoyage.com/admin/ajout_devis_client_etape4.php/?id=<?php echo $id; ?>";
            }
