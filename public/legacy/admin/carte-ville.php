...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
    ...
    $stmt ->execute();
    echo "<meta http-equiv='refresh' content='0;url=carte-ville.php?pays=$pays&ville=$ville'/>";
}
else
{
...
?>
                     ...
                     <li>
                            ...
                            <li>
                                    ...
                                    <a href="ajout_carte.php" rel="tooltip" data-placement="left" title="Nouvelle carte">
                                        <i class="icon-plus"></i> Nouvelle carte
                                    </a>
            ...
            <div class="row">
                <div class="span4">
                    <div class="blockoff-right">
                     ...
                     <p><a href="cartes.php" class="btn btn-danger btn-lg btn-block">Revenir au liste de carte</a></p>
                </div>
                <div class="span12">
        ...
        <?php
            $i = 1;
            $stmt = $conn->prepare('SELECT * FROM carte WHERE pays =:pays AND ville =:ville GROUP BY ville ORDER BY pays ASC');
        ...
        ?>
                    ...
                    <div id="Person-<?php echo $i; ?>" class="box">
                        ...
                        <?php
                            $v=1;
                            $stmt1 = $conn->prepare('SELECT * FROM carte WHERE pays =:pays AND ville =:ville ORDER BY etat, categorie, titre');
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="carte-ville.php?id_carte=<?php echo $account1 -> id_carte; ?>&action=delete&pays=<?php echo ($account1 -> pays); ?>&ville=<?php echo ($account1 -> ville); ?>" onclick="return confirm('Vous etes sur de supprimer cette ligne')" class="btn" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Supprimer</a>
                                        <br>
                                    <a href="modif_carte.php?id_carte=<?php echo $account1 -> id_carte; ?>" class="btn" style="font-size: 10px;padding: 0 14px;margin-bottom: 5px;"><i class="icon-edit"></i> Modifier</a><br>

                                    <a href="dupliquer_carte.php?id_carte=<?php echo $account1 -> id_carte; ?>" class="btn" style="font-size: 10px;padding: 0 12px;margin-bottom: 5px;"><i class="icon-bookmark"></i> Dupliquer</a>
                                        <br>
