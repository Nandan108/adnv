...
if (isset($_SESSION['account_login'])) {
    ...
    $url                 = $_GET['id_prestation_hotel'];
    $tab                 = explode('?', $url);
    $id_prestation_hotel = $tab[0];
    ...
    if (isset($_POST['save'])) {
        ...
        $stmt5 = $conn->prepare(
            'UPDATE prestation_hotel SET id_hotel =:id_hotel,
                id_partenaire =:id_partenaire,
                debut_validite =:debut_validite,
                fin_validite =:fin_validite,
                taux_change =:taux_change,
                taux_commission =:taux_commission,
                prix_net_adulte =:prix_net_adulte,
                prix_brute_adulte =:prix_brute_adulte,
                total_adulte =:total_adulte,
                prix_net_enfant =:prix_net_enfant,
                prix_brute_enfant =:prix_brute_enfant,
                total_enfant =:total_enfant,
                prix_net_bebe =:prix_net_bebe,
                prix_brute_bebe =:prix_brute_bebe,
                total_bebe =:total_bebe,
                photo =:photo
            WHERE id_prestation_hotel =:id_prestation_hotel
        ');

        $stmt5->bindValue('id_prestation_hotel', addslashes($_POST['id_prestation_hotel']));
        ...
        echo "<script type='text/javascript'>alert('Modification prestation hôtel effectué, vous pouvez ajouté un autre');</script>";
        echo "<meta http-equiv='refresh' content='0;url=liste_prestation_hotel.php?dossier=$dossier'/>";
    }



    $stmt = $conn->prepare('SELECT * FROM prestation_hotel  WHERE id_prestation_hotel=:id_prestation_hotel');
    $stmt->bindValue('id_prestation_hotel', $id_prestation_hotel);
    $stmt->execute();
    $accountx = $stmt->fetch(PDO::FETCH_OBJ);
            ...
            <div class="row">
                <div class="span7">
                    <header class="page-header">
                        <h3>Repas Hôtels | <span style="font-size: 12px;color:#00CCF4;">Modification repas hôtel </span>
                        </h3>
                    </header>
                </div>
                <div class="span9">
    ...
    <section id="my-account-security-form" class="page container">
        <form id="userSecurityForm" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
            ...
            <input type="hidden" name="photo" value="<?php echo $accountx->photo; ?>">
            <div class="container">

                <div class="alert alert-block alert-info">
                    <p>
                        Vous êtes sur l'interface d' ajout de prestation hôtel. Assurer vous de bien remplir tous les champs
                        ci-dessous.
                    </p>
                </div>
                <div class="row">
                    <div id="acct-password-row" class="span7">
                        <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 200px;">
                            ...
                            $stmt01 = $conn->prepare('SELECT * FROM hotels_new WHERE id =:id_hotel');
                            $stmt01->bindValue('id_hotel', $dossier);
                            $stmt01->execute();
                            $hotel = $stmt01->fetch(PDO::FETCH_OBJ);

                            ?>
                            <input type="hidden" name="id_hotel" value="<?php echo $hotel->id; ?>">
                            <input type="hidden" name="id_prestation_hotel"
                                value="<?php echo $accountx->id_prestation_hotel; ?>">
                            ...
                            <div class="control-group ">
                                ...
                                <div class="controls">
                                    <input id="current-pass-control" name="id_partenaire" class="span4" type="text"
                                        value="<?php echo ($accountx->id_partenaire); ?>">
                            ...
                            <div class="control-group ">
                                ...
                                <div class="controls" style="margin-left: 100px;">
                                    <input id="current-pass-control" name="debut_validite" class="span2" type="date"
                                        value="<?php echo $accountx->debut_validite; ?>" autocomplete="false" required>
                            ...
                            <div class="control-group ">
                                ...
                                <div class="controls" style="margin-left: 100px;">
                                    <input id="current-pass-control" name="fin_validite" class="span2" type="date"
                                        value="<?php echo $accountx->fin_validite; ?>" autocomplete="false" required>
                    ...
                    <div id="acct-password-row" class="span5">
                        <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 200px;">
                                ...
                                <div class="controls" style="margin-left: 100px;">
                                    <select class="span3" name="taux_change" id="series" onchange="getval(this);">
                                        ...
                                        while ($account0 = $stmt0->fetch(PDO::FETCH_OBJ)) {
                                            ?>
                                            <option value="<?php echo $account0->taux; ?>" <?php
                            ...
                            <input type="hidden" class="form-control" name=""
                                value="<?php echo $accountx->taux_change; ?>" id="taux">
                            <div class="control-group ">
                                <div class="control-group ">
                                    ...
                                    <div class="controls" style="margin-left: 100px;">
                                        <input type="text" class="span3" name="taux_commission" id="champ0"
                                            ...
                                            value="<?php echo $accountx->taux_commission; ?>" />
                                    </div>
                                </div>
                    ...
                    <div id="acct-password-row" class="span8">
                        <fieldset>
                            ...
                            <input type="hidden" id="champ1" value="<?php echo $accountx->taux_commission; ?>">
                            <div class="span2">
                            ...
                            <div class="span2">
                                ...
                                <input type="text" class="span2" name="prix_net_adulte" id="champ2"
                                    ...
                                    value="<?php echo $accountx->prix_net_adulte; ?>">
                            </div>
                            <div class="span2">
                                <input type="text" class="span2" name="prix_brute_adulte" id="champ3"
                                    value="<?php echo $accountx->prix_brute_adulte; ?>">
                            </div>
                            ...
                            <div class="span2">
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" class="span2" name="total_adulte" id="champ4"
                                        value="<?php echo $accountx->total_adulte; ?>">
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="span15">
                        ...
                        <div class="span2">
                            <input type="text" class="span2" name="prix_net_enfant" id="champ22"
                                ...
                                value="<?php echo $accountx->prix_net_enfant; ?>">
                        </div>
                        <div class="span2">
                            <input type="text" class="span2" name="prix_brute_enfant" id="champ33"
                                value="<?php echo $accountx->prix_brute_enfant; ?>">
                        </div>
                        ...
                        <div class="span2">
                            <div class="form-group input-group">
                                ...
                                <input type="text" class="span2" name="total_enfant" id="champ44"
                                    value="<?php echo $accountx->total_enfant; ?>">
                            </div>
                        </div>
                    ...
                    <div class="span15">
                        ...
                        <div class="span2">
                            <input type="text" class="span2" name="prix_net_bebe" id="champ222"
                                ...
                                value="<?php echo $accountx->prix_net_bebe; ?>">
                        </div>
                        <div class="span2">
                            <input type="text" class="span2" name="prix_brute_bebe" id="champ333"
                                value="<?php echo $accountx->prix_brute_bebe; ?>">
                        </div>
                        ...
                        <div class="span2">
                            <div class="form-group input-group">
                                ...
                                <input type="text" class="span2" name="total_bebe" id="champ444"
                                    value="<?php echo $accountx->total_bebe; ?>">
                            </div>
                        </div>
