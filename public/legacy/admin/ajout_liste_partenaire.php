                    ...
                    <div id="acct-password-row" class="span6">
                        <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;">
                            ...
                            <table style="width: 100%">
                                ...
                                <?php
                                $stmt1 = $conn->prepare('SELECT * FROM partenaire_liste');
                                $stmt1->execute();
                                while ($account1 = $stmt1->fetch(PDO::FETCH_OBJ)) {
                                    ?>
                                    <tr>
                                        <td><img src="<?php echo $account1->photo; ?>" width="50" height="30"></td>
                                        <td><?php echo ($account1->type); ?></td>
                                        <td><?php echo $account1->nom; ?></td>
                                        <td><a href="ajout_liste_partenaire.php?id_partenaire_list=<?php echo $account1->id_partenaire_list; ?>&action2=delete"
