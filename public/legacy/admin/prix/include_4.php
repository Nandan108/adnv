<?php
    if($adulte=="1")
                                            ...
                                            $adulte_total = round(($account5555 -> adulte_1_total),2);
                                            $adulte_total_2 = "0";
                                            $adulte_total_3 = "0";
                                            $adulte_total_4 = "0";  
                                        ...
                                        if($adulte=="2")
                                            ...
                                            $adulte_total = round(($account5555 -> double_adulte_1_total),2);
                                            $adulte_total_2 = round(($account5555 -> double_adulte_2_total),2);
                                            $adulte_total_3 = "0";
                                            $adulte_total_4 = "0";  
                                        ...
                                        if($adulte=="3")
                                            ...
                                            $adulte_total = round(($account5555 -> tripple_adulte_1_total),2);
                                            $adulte_total_2 = round(($account5555 -> tripple_adulte_2_total),2);
                                            $adulte_total_3 = round(($account5555 -> tripple_adulte_3_total),2);
                                            $adulte_total_4 = "0";  
                                        ...
                                        if($adulte=="4")
                                            ...
                                            $adulte_total = round(($account5555 -> quatre_adulte_1_total),2);
                                            $adulte_total_2 = round(($account5555 -> quatre_adulte_2_total),2);
                                            $adulte_total_3 = round(($account5555 -> quatre_adulte_3_total),2);
                                            $adulte_total_4 = round(($account5555 -> quatre_adulte_4_total),2);
