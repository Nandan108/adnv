                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div id="acct-password-row" class="span8">
                            <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;overflow: hidden;height: 330px; ">
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">CARACTERISTIQUE</h4>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="control-group ">
                                        ...
                                        <div class="controls">
                                            <input id="challenge_question_control" type='text' class="span5" name="pays" value="<?=$account->pays?>">
                                            <!-- select id="challenge_question_control" class="span5" name="pays">
                                            <?php
                                                $stmt0 = $conn->prepare('SELECT * FROM lieux GROUP BY pays');
                                                $stmt0 ->execute();
                                                while($account0 = $stmt0 ->fetch(PDO::FETCH_OBJ))
                                                {
                                            ?>
                                                     <option value="<?php echo ($account0 -> pays); ?>" <?php if(($account -> pays) == ($account0 -> pays)){ echo 'selected';} ?>><?php echo ($account0 -> pays); ?></option>
                                            <?php
                                                }
                                            ?>
                                            </select -->
                                    ...
                                    <div class="control-group ">
                                        ...
                                        <div class="controls">
                                            <select id="challenge_question_control" class="span5" name="company">
                                                 <?php
                                                ...
                                                ?>
                                                    ...
                                                    <option value="<?php echo ($account01 -> company); ?>"  <?php if(($accountx -> compagnie) == ($account01 -> company)){ echo 'selected';} ?>><?php echo ($account01 -> company); ?></option>
                                                    <?php
                                                        }
                                                    ?>
                                            </select>
                                    ...
                                    <div class="control-group ">
                                        ...
                                        <div class="controls">
                                            <select id="challenge_question_control" class="span5" name="class_reservation">
                                                ...
                                                <option value="Eco (Airlines)" <?php if($accountx -> class_reservation == 'Eco (Airlines)'){ echo 'selected';} ?>>Eco (Airlines)</option>
                                                <option value="Eco (Charter)" <?php if($accountx -> class_reservation == 'Eco (Charter)'){ echo 'selected';} ?>>Eco (Charter)</option>
                                                <option value="Eco (Contingent)" <?php if($accountx -> class_reservation == 'Eco (Contingent)'){ echo 'selected';} ?>>Eco (Contingent)</option>
                                                <option value="Eco (Premium)" <?php if($accountx -> class_reservation == 'Eco (Premium)'){ echo 'selected';} ?>>Eco (Premium)</option>
                        ...
                        <div id="acct-password-row" class="span8">
                            ...
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">LOCALISATION</h4>
                                ...
                                <div class="control-group ">
                                        ...
                                        <div class="controls">
                                            <input id="current-pass-control" name="aeroport_transit" class="span5" value="<?php echo stripslashes(($accountx -> aeroport_transit)); ?>" type="text" value="" autocomplete="false">
...
<div id="acct-password-row" class="span8">
                                <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 362px;">
                                <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">TAUX - DEPART</h4>
                                     ...
                                     <?php
                                        ...
                                        ?>
                                                <option value="<?php echo $account0 -> taux; ?>"
                                                  ...
                                                  <?php
                                                  $taux_change = $accountx -> taux_change;
                                                  if($taux_change == $account0 -> taux)
                                                    {
                                                        echo "selected";
                                                    }
                                                  ?>

                                                  ><?php echo ($account0 -> nom_monnaie.' : '.$account0 -> code .' - '. $account0 -> taux); ?></option>
                                        <?php
                                            }
                                        ?>
                                        </select>
...
<input type="hidden" class="form-control" name="" id="taux"  value="<?php echo $accountx -> taux_change; ?>">


                                <div class="control-group ">
                                    <label class="control-label">Commission</label>
                                    <div class="controls">
                                                                         <input type="text" class="span5" name="taux_commission" id="champ0" OnKeyUp="javascript:calcul00(this.value, document.getElementById('champ1').value);" value="<?php echo $accountx -> taux_commission; ?>">
                                    </div>
                                </div>
<hr>
                                <div class="control-group ">
...
?>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls" style="font-size: 10px;">
                                       <input type="radio" name="jour_arrive_dv" value="MemeJour" checked> Même jour &nbsp;&nbsp;&nbsp;<br>
                                                <input type="radio" name="jour_arrive_dv" value="J+1"> J+1
                        ...
                        <div id="acct-password-row" class="span4">
                            <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 340px;">
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">VENTE</h4>
                                <div class="control-group ">
                                    <label class="control-label" style="width: 60px;">Début</label>
                                    <div class="controls" style="margin-left: 100px;">
                                        <input id="current-pass-control" name="debut_vente" class="span2" type="date" value="<?php echo ($account -> debut_vente); ?>" autocomplete="false" required>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls" style="margin-left: 100px;">
                                         <input id="current-pass-control" name="fin_vente" class="span2" type="date"  value="<?php echo ($account -> fin_vente); ?>"autocomplete="false" required>
                        ...
                        <div id="acct-password-row" class="span4">
                            <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 340px;">
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">VOYAGE</h4>
                                <div class="control-group ">
                                    <label class="control-label" style="width: 60px;">Début</label>
                                    <div class="controls" style="margin-left: 100px;">
                                        <input id="current-pass-control" name="debut_voyage" class="span2" type="date" value="<?php echo ($account -> debut_voyage); ?>" autocomplete="false" required>
                                ...
                                <div class="control-group ">
                                    <label class="control-label" style="width: 60px;">Fin</label>
                                    <div class="controls" style="margin-left: 100px;">
                                         <input id="current-pass-control" name="fin_voyage" class="span2" type="date" value="<?php echo ($account -> fin_voyage); ?>" autocomplete="false" required>
  ...
  result1 = parseFloat(chiffre1)+parseFloat(chiffre2);
    document.getElementById('champ12_first').value = parseFloat(result1.toFixed(2));
                        ...
                        <div id="acct-verify-row" class="span16">
                            ...
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">PRIX</h4>
...
<!-- AJOUT ADULTE -->
 ...
 <div class="span16">
  ...
  <input type="hidden" id="champ1" value="">
              ...
              <div class="span3">
                  <input type="text" class="span2" name="adulte_vol_net" id="champ2" value="<?php echo $accountx -> adulte_vol_net; ?>" OnKeyUp="javascript:calcul(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);" style="margin: 5px;">
              </div>
              <div class="span3">
                  <input type="text" class="span2"  name="adulte_vol_brut" id="champ3" style="margin: 5px;" value="<?php echo $accountx -> adulte_vol_brut; ?>">
              </div>
              <div class="span3">
                  <input type="text" class="span2" name="adulte_taxe" value="<?php echo $accountx -> adulte_taxe; ?>" id="champ33" OnKeyUp="javascript:calcul_calcul(this.value,document.getElementById('champ3').value);" style="margin: 5px;">
              </div>
              <div class="span3">
                  <div class="form-group input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="text" class="span2"   name="adulte_total"  value="<?php echo $accountx -> adulte_total; ?>" id="champ4" style="margin: 5px;">
                  </div>
              </div>
  </div>
...
<div class="span16">
  ...
  <input type="hidden" id="champ1" value="">
              ...
              <div class="span3">
                  <input type="text" class="span2" name="enfant_vol_net" id="champ5" value="<?php echo $accountx -> enfant_vol_net; ?>"  OnKeyUp="javascript:calcul2(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);" style="margin: 5px;">
              </div>
              <div class="span3">
                  <input type="text" class="span2" name="enfant_vol_brut" id="champ7" style="margin: 5px;" value="<?php echo $accountx -> enfant_vol_brut; ?>">
              </div>
              <div class="span3">
                  <input type="text" class="span2" name="enfant_taxe" id="champ6" value="<?php echo $accountx -> enfant_taxe; ?>" OnKeyUp="javascript:calcul_calcul2(this.value,document.getElementById('champ7').value);" style="margin: 5px;">
              </div>
              <div class="span3">
                  <div class="form-group input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="text" class="span2" name="enfant_total" id="champ8" value="<?php echo $accountx -> enfant_total; ?>" style="margin: 5px;">
                  </div>
              </div>
...
<div class="span16">
  <input type="hidden" id="champ1" value="">
              ...
              <div class="span3">
                  <input type="text" class="span2" name="bebe_vol_net" id="champ9" value="<?php echo $accountx -> bebe_vol_net; ?>" OnKeyUp="javascript:calcul3(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);" style="margin: 5px;">
              </div>
              <div class="span3">
                  <input type="text" class="span2"  name="bebe_vol_brut" id="champ11" style="margin: 5px;"  value="<?php echo $accountx -> bebe_vol_brut; ?>" >
              </div>
              <div class="span3">
                  <input type="text" class="span2" name="bebe_taxe" id="champ10" value="<?php echo $accountx -> bebe_taxe; ?>"  OnKeyUp="javascript:calcul_calcul3(this.value,document.getElementById('champ11').value);" style="margin: 5px;">
              </div>
              <div class="span3">
                  <div class="form-group input-group">
                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                    <input type="text" class="span2"  name="bebe_total"  id="champ12" style="margin: 5px;"  value="<?php echo $accountx -> bebe_total; ?>">
                  </div>
              </div>
