...
$characts   = 'ABCDEFGHIJKLMNOPQRSTUVWXYZaAbBcCdDeEfFgGhHiIkKlMmNnoOpPqOstuvwz';    
    ...
    $stmt = $conn->prepare('SELECT * FROM carte  WHERE id_carte= :id_carte');
     ...
     #map {
        ...
        <section id="my-account-security-form" class="page container">
            <form id="userSecurityForm" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id_carte" value="<?php echo $account -> id_carte; ?>">
...
<div id="acct-password-row" class="span4">
                            <fieldset>
                                <legend>Information  | <span style="font-size: 12px;color:#00CCF4;">Modification carte </span></legend><br>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <select class="span4" id="name" name="recommande" style="margin-left: -84px;">
                                            <option value="Recommandé"  <?php if($account -> recommande =="Recommandé"){echo "selected"; } ?>>Recommandé</option>
                                            <option value="Pas recommandé" <?php if($account -> recommande =="Pas recommandé"){echo "selected"; } ?>>Pas recommandé</option>
                                        </select>
                                    </div>
                                </div>
...
?>
                      ...
                      <div class="control-group ">
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="code_postale" class="span4" type="text" value="<?php echo $account -> code_postale; ?>" autocomplete="false" >
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="site" class="span4" type="text" value="<?php echo stripslashes($account -> site); ?>" autocomplete="false" >
