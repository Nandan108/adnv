...
$stmt55 = $conn ->prepare ("insert into `package_manuel_vol`(`id_sejour_manuel_vol`, `id_sejour`, `compagnie`, `class_reservation`, `ville_depart`, `ville_arrive`, `adulte_vol_brut`, `adulte_taxe`, `enfant_vol_brut`, `enfant_taxe`, `bebe_vol_brut`, `bebe_taxe`, `jour_depart`) VALUE (:id_sejour_manuel_vol, :id_sejour, :compagnie, :class_reservation, :ville_depart, :ville_arrive, :adulte_vol_brut, :adulte_taxe, :enfant_vol_brut, :enfant_taxe, :bebe_vol_brut, :bebe_taxe, :jour_depart )");
