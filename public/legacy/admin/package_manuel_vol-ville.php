...
$ville = $_GET['ville'];
        ...
        $stmt = $conn->prepare('delete from package_manuel_vol WHERE id_sejour = :id_sejour');
        $stmt ->bindValue('id_sejour',$id_sejour);
        $stmt ->execute();

        echo "<meta http-equiv='refresh' content='0;url=package_manuel_vol-ville.php?pays=$pays&ville=$ville'/>";
}
...
?>  
    <script src="js/jquery-1.11.3.min.js"></script>            
                    ...
                    <div class="span9">
                        <ul class="nav nav-pills">
                            <li>
                                    ...
                                    <a href="ajout_package_vol.php" rel="tooltip" data-placement="left" title="Nouveau package">
                                        <i class="icon-plus"></i> Nouveau séjour vol
                                    </a>
        ...
        <?php
            $i = 1;
            $stmt = $conn->prepare('SELECT * FROM package WHERE pays =:pays AND ville =:ville AND manuel =:manuel GROUP BY ville ORDER BY pays ASC');
        ...
        ?>
                    ...
                    <div id="Person-<?php echo $i; ?>" class="box">
                        <div class="box-header">
                            ...
                            <h5><?php echo ($account -> pays); ?>&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="ajout_package_vol.php?pays=<?php echo ($account -> pays); ?>" class="btn btn-danger" style="margin: -11px 0 0 0;
font-size: 12px;
padding: 5px 11px;
line-height: 1px;"><i class="icon-plus"></i> Ajouter package</a></span></h5>
                            
                        </div>
<?php
                            $stmt1111 = $conn->prepare('SELECT * FROM package WHERE pays =:pays AND ville =:ville AND manuel =:manuel GROUP BY titre');
                             $stmt1111 ->bindValue('pays', ($pays));
                            $stmt1111 ->bindValue('ville', ($ville));
                            $stmt1111 ->bindValue('manuel', '2');
                            $stmt1111 ->execute();
...
?>
                        ...
                        <div class="box-content box-table">
                            <h3 style="padding: 0 20px;"><?php echo (stripslashes($account1111 -> titre)); ?></h3><hr>
                        ...
                        <?php
                            ...
                            $zz= 1;
                            $stmt1 = $conn->prepare('SELECT * FROM package WHERE titre =:titre AND manuel =:manuel AND pays =:pays AND ville =:ville  ORDER BY debut_vente ASC');
                            $stmt1 ->bindValue('titre', $account1111 -> titre);
                            $stmt1 ->bindValue('pays', ($pays));
                            $stmt1 ->bindValue('ville', ($ville));
                            $stmt1 ->bindValue('manuel', '2');
                            ...
                            $stmt19 = $conn->prepare('SELECT * FROM package_manuel_vol WHERE id_sejour =:id_sejour');
                        ...
                        ?>                 
                                ...
                                <tr>
                                    <td>
                                         <?php
                                                    ...
                                                    {
                                                        ?>
                                                        <a href="package_manuel_vol-ville.php?id_sejour=<?php echo $account -> id_sejour; ?>&action=avant&pays=<?php echo $pays; ?>&ville=<?php echo $ville; ?>" onclick="return confirm('Voulez-vous mettre cette offre en avant')" class="btn" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Mettre en avant</a>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                                                                                ?>
                                                        <a href="package_manuel_vol-ville.php?id_sejour=<?php echo $account -> id_sejour; ?>&action=normal&pays=<?php echo $pays; ?>&ville=<?php echo $ville; ?>" onclick="return confirm('Voulez-vous mettre cette offre en avant')" class="btn btn-primary" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Desactiver mise en avant</a>
                                                        <?php
                                                    }
                                ...
                                Titre   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo (stripslashes($account -> titre)); ?><br>
                                Compagnie   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo (stripslashes($account19 -> compagnie)); ?><br>
                                Class de réservation   &nbsp;&nbsp;: <?php echo (stripslashes($account19 -> class_reservation)); ?><br>
                                Ville de départ   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo (stripslashes($account19 -> ville_depart)); ?><br>
                                Ville d' arrivée   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo (stripslashes($account19 -> ville_arrive)); ?>
                                <hr>
...
?>
<small class="text-muted"> <b>Début vente </b> &nbsp;&nbsp;:  &nbsp;<?php echo $date_format[2]; ?> <?php echo $mois_format; ?> <?php echo $date_format[0]; ?></small><br>
<?php
...
<small class="text-muted"> <b>Fin vente</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  &nbsp;<?php echo $date_format[2]; ?> <?php echo $mois_format; ?> <?php echo $date_format[0]; ?></small><br>
...
?>
<small class="text-muted"> <b>Début Voyage </b> &nbsp;&nbsp;:  &nbsp;<?php echo $date_format[2]; ?> <?php echo $mois_format; ?> <?php echo $date_format[0]; ?></small><br>
<?php
...
<small class="text-muted"> <b>Fin Voyage </b>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;:  &nbsp;<?php echo $date_format[2]; ?> <?php echo $mois_format; ?> <?php echo $date_format[0]; ?></small>
...
<div id="acct-verify-row" class="span4">
    <h4>Single</h4>
    <small class="text-muted"> <b>Adulte 1 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte1_sejour_1; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>1er enfant </b> &nbsp;&nbsp;:  <?php echo $account -> enfant1_sejour_1; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>2em enfant </b>&nbsp;:  <?php echo $account -> enfant2_sejour_1; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>Bébé </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  <?php echo $account -> bebe_sejour_1; ?>&nbsp;</small><br>
</div>

<div id="acct-verify-row" class="span4">
    <h4>Double</h4>
    <small class="text-muted"> <b>Adulte 1 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte1_sejour; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>Adulte 2 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte2_sejour; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>1er enfant </b> &nbsp;&nbsp;:  <?php echo $account -> enfant1_sejour; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>2em enfant </b>&nbsp;:  <?php echo $account -> enfant2_sejour; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>Bébé </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  <?php echo $account -> bebe_sejour; ?>&nbsp;</small><br>

</div>

<div id="acct-verify-row" class="span4">
    <h4>Tripple</h4>
    <small class="text-muted"> <b>Adulte 1 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte1_sejour_3; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>Adulte 2 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte2_sejour_3; ?>&nbsp;</small><br>
    <small class="text-muted"> <b>Adulte 3 </b>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;:  <?php echo $account -> adulte3_sejour_3; ?>&nbsp;</small><br>
                                    ...
                                    <td>
                                        ...
                                        <a href="package_manuel_vol.php?id_sejour=<?php echo $account -> id_sejour; ?>&action=delete&pays=<?php echo $pays; ?>&ville=<?php echo $ville; ?>" onclick="return confirm('Vous etes sur de supprimer cette ligne? Cette action va supprimer tous les informations réliées à cette enregistrement')" class="btn" style="font-size: 10px;padding: 0 10px;margin-bottom: 5px;"><i class="icon-trash"></i> Supprimer</a>
                                        <br>
                                        <a href="modification_package_manuel_vol.php?id_sejour=<?php echo $account -> id_sejour; ?>" class="btn" style="font-size: 10px;padding: 0 14px;margin-bottom: 5px;"><i class="icon-edit"></i> Modifier</a>
                                        <br>
                                        <a href="duplication_package_manuel_vol.php?id_sejour=<?php echo $account -> id_sejour; ?>" class="btn" style="font-size: 10px;padding: 0 12px;margin-bottom: 5px;"><i class="icon-bookmark"></i> Dupliquer</a>
