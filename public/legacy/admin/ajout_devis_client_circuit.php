<?php
 ...
 $xx=$_GET['id'];
  ...
  while($account = $stmt ->fetch(PDO::FETCH_OBJ))
  {
    ...
    $stmt5 = $conn ->prepare ('UPDATE reservation_info_devis_client_circuit SET destination_pays =:destination_pays,  
   depart =:depart, 
   retour =:retour, 
   adulte =:adulte, 
   enfant =:enfant, 
   ...
   $stmt5->execute();
   echo "<meta http-equiv='refresh' content='0;url=ajout_devis_client_circuit_etape2.php?id=$id'/>";
