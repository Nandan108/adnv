...
$stmt5 = $conn ->prepare (
    "INSERT INTO `prestation_hotel` (`id_hotel`, `id_partenaire`, `debut_validite`, `fin_validite`, `taux_change`, `taux_commission`, `prix_net_adulte`, `prix_brute_adulte`, `total_adulte`, `prix_net_enfant`, `prix_brute_enfant`, `total_enfant`, `prix_net_bebe`, `prix_brute_bebe`, `total_bebe`, `photo`)
    VALUE (
        :id_hotel,
        :id_partenaire,
        :debut_validite,
...
$stmt5->execute();
  ...
  $urle = $_GET['dossier'];
  echo "<script type='text/javascript'>alert('Ajout prestation hôtel effectué, vous pouvez ajouté un autre');</script>";
  echo "<meta http-equiv='refresh' content='0;url=liste_prestation_hotel.php?dossier=$urle'/>";
}
                ...
                <div class="row">
                    <div class="span7">
                        <header class="page-header">
                            <h3>Prestation Hôtels | <span style="font-size: 12px;color:#00CCF4;">Ajouter un prestation hôtel </span></h3>
                        </header>
                    </div>
                    <div class="span9">
            ...
            <form id="userSecurityForm" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                <div class="container">
                    ...
                    <div class="alert alert-block alert-info">
                        <p>
                            Vous êtes sur l'interface d' ajout de prestation hôtel. Assurer vous de bien remplir tous les champs ci-dessous.
                        </p>
                    </div>
                    <div class="row">
                        <div id="acct-password-row" class="span7">
                            <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 200px;">
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">TYPE PRESTATION</h4>

                                <?php

                                        $stmt01 = $conn->prepare('SELECT * FROM hotels_new WHERE id = ?');
                                        $stmt01->execute([$_GET['dossier']]);
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input disabled id="current-pass-control" name="hotel" class="span4" type="text" value="<?php echo ($hotel->nom); ?>" >
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                      <input  id="current-pass-control" name="id_partenaire" class="span4" type="text" maxlength="30">
                        ...
                        <div id="acct-password-row" class="span4">
                            <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 200px;">
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">VALIDITE</h4>
                                <div class="control-group ">
                                    <label class="control-label" style="width: 60px;">Début</label>
                                    <div class="controls" style="margin-left: 100px;">
                                        <input id="current-pass-control" name="debut_validite" class="span2" type="date" value="" autocomplete="false" required>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls" style="margin-left: 100px;">
                                        <input id="current-pass-control" name="fin_validite" class="span2" type="date" value="" autocomplete="false" required>
                        ...
                        <div id="acct-password-row" class="span5">
                            <div style="padding: 10px;margin-left: 20px;border: 3px solid;margin-bottom: 30px;height: 200px;">
                            <h4 style="text-align: center;margin-bottom: 18px;background:#6b8c2d;padding: 5px;color:#FFF;margin-top: 0px;margin-bottom: 30px;">TAUX & COMMISSION</h4>
                                ...
                                <div class="control-group ">
                                    ...
                                    <div class="controls" style="margin-left: 100px;">
                                        <input type="text" class="span3" name="taux_commission" id="champ0"  OnKeyUp="javascript:calcul001(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);"/>
                                    </div>
                                </div>
                        ...
                        <div id="acct-password-row" class="span8">
                            <fieldset>
                                <legend>Etape 1 :: Configuration type de prestation </legend><br>
...
<input type="hidden" id="champ1" value="">
              ...
              <div class="span2">
                    ...
                    <input type="text" class="span2" name="prix_net_adulte" id="champ2" OnKeyUp="javascript:calcul(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);">
              </div>
              <div class="span2">
...
<div class="span15">
              ...
              <div class="span2">
                 <input type="text" class="span2" name="prix_net_enfant" id="champ22" OnKeyUp="javascript:calcul1(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);">
              </div>
              <div class="span2">
...
<div class="span15">
              ...
              <div class="span2">
                  <input type="text" class="span2" name="prix_net_bebe" id="champ222" OnKeyUp="javascript:calcul2(this.value, document.getElementById('champ1').value, document.getElementById('taux').value);">
              </div>
              <div class="span2">
