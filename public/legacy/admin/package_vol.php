...
if (isset($_SESSION['account_login'])) {
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'delete') {
        ...
        $stmt = $conn->prepare('delete from package_vol WHERE id_sejour = :id_sejour');
        $stmt->bindValue('id_sejour', $id_sejour);
        $stmt->execute();
                            ...
                            <li>
                                ...
                                <ul id="liste-<?php echo ($pays1) . '_' . $i; ?>" style="display: none">
                                    ...
                                    while ($account70 = $stmt70->fetch(PDO::FETCH_OBJ)) {
                                        ...
                                        <li>
                                            <a
                                                href="package_vol-ville.php?pays=<?php echo ($account->pays); ?>&ville=<?php echo ($account70->ville); ?>">
                        ...
                        <div class="box-header">
                            ...
                            <h5>
                                <?php echo ($account->pays); ?>&nbsp;&nbsp;&nbsp;&nbsp;<span><a
                                        ...
                                        class="btn btn-danger" style="margin: -11px 0 0 0;font-size: 12px;padding: 5px 11px;line-height: 1px;"><i class="icon-plus"></i> Ajouter package</a></span>
                            </h5>
                                        ...
                                        while ($account = $stmt1->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    if ($account->avant == "0") {
                                                        ?>
                                                        <a href="package_vol.php?id_sejour=<?php echo $account->id_sejour; ?>&action=avant"
                                                        ...
                                                        ?>
                                                        <a href="package_vol.php?id_sejour=<?php echo $account->id_sejour; ?>&action=normal"
                                                ...
                                                <td>
                                                    ...
                                                    Compagnie :
                                                    <?php echo (stripslashes($account19->compagnie)); ?>
                                                    <hr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="package_vol.php?id_sejour=<?php echo $account->id_sejour; ?>&action=delete"
                                                    ...
                                                    <br>
                                                    <a href="modification_package_vol.php?id_sejour=<?php echo $account->id_sejour; ?>"
                                                        class="btn" style="font-size: 10px;padding: 0 14px;margin-bottom: 5px;"><i
                                                            class="icon-edit"></i> Modifier</a>
                                                    <br>
                                                    <a href="duplication_package_vol.php?id_sejour=<?php echo $account->id_sejour; ?>"
