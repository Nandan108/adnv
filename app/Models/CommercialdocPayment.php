...
class CommercialdocPayment extends Model
{
    use HasFactory;

    protected $table = 'commercialdoc_payments';
    protected $fillable = [
        'commercialdoc_id',
        'type',
        'data',
    ...
    public function toSpecificType()
    {
        $class = match ($this->type) {
            ...
            'transfert_line'     => DocInfo\TransferLine::class,
            'hotel_line'         => DocInfo\HotelLine::class,
            'transfert_comments' => DocInfo\TransfertComments::class,
            'traveler_line'      => DocInfo\TravelerLine::class,
            'trip_info'          => DocInfo\TripInfo::class,
        };
