...
class FinalQuoteNotificationMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $html = view('emails.finalQuoteNotification', ['quote' => $this->quote])->render();
        ...
        return $this->subject('Votre devis final ADN Voyage n°' . $this->quote->doc_id)
            ->html($inlinedHtml);
    }
